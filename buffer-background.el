...
;; and automatic assignment to specific buffers.
...
(defun buffer-background--enable ()
  ...
  (when-let ((image-file (or buffer-background-image-file
                            (buffer-local-value 'buffer-background-image-file (current-buffer)))))
